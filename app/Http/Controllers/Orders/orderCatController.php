...
class orderCatController extends Controller
{
    ...
    {
        try {
            $order_cat = OrderCategory::paginate(20);
            return $order_cat;
        } catch (\Throwable $th) {
            throw $th;
    ...
    {
        try {
            $count_ordercat = OrderCategory::where('id',$id)->count();
            if ($count_ordercat < 1) {
                return ([
                    'code'=> -1,
            ...
            OrderCategory::where('id',$id)->update([
                'name' => $request->name,
                'description' => $request->description
            ]);
            return ([
    ...
    public function destroy($id)
    {
        try {
            ...
            OrderCategory::where('id',$id)->delete();
            return ([
                'code'=> 1,
