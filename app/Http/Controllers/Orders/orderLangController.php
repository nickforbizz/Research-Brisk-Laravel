...
class orderLangController extends Controller
{
    ...
    {
        try {
            $order_cat = OrderLanguage::paginate(20);
            return $order_cat;
        } catch (\Throwable $th) {
            throw $th;
    ...
    {
        try {
            $count_ordercat = OrderLanguage::where('id',$id)->count();
            if ($count_ordercat < 1) {
                return ([
                    'code'=> -1,
            ...
            OrderLanguage::where('id',$id)->update([
                'name' => $request->name,
                'description' => $request->description
            ]);
            return ([
    ...
    public function destroy($id)
    {
        try {
            ...
            OrderLanguage::where('id',$id)->delete();
            return ([
                'code'=> 1,
